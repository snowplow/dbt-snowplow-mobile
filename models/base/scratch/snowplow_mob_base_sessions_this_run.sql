...
{%- set lower_limit, 
        upper_limit,
         _,
        lower_limit_minus_max_session_days  = snowplow_utils.return_base_new_event_limits(ref('snowplow_mob_base_new_event_limits')) %}
...
from {{ ref('snowplow_mob_base_sessions_lifecycle_manifest')}} s
